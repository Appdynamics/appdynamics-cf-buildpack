...
func CopyBrats(version string) *cutlass.App {
	...
	Fail("Implement CopyBrats for your buildpack.")
	// TODO Create appropriate dependency version file to the fixtures directory
	//   (i.e. the file needed to detect an app in bin/detect)
